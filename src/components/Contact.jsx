    ...
    >
      ...
      <div className='flex justify-between items-center mt-8 lg:mt-16 flex-col lg:flex-row'>
          ...
          <form className='w-full space-y-3 lg:space-y-5'>
            ...
            >
              ...
              <div className='flex items-center gap-x-2 lg:gap-x-5'>
                <motion.a
                  href="mailto:tusharnavneet@gmail.com"
                ...
                <motion.a
                  href="https://linkedin.com/in/tusharnavneet"
                  target="_blank"
                ...
                <motion.a
                  href="https://github.com/tusharnavneet"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white p-2 lg:p-3 rounded border-2 border-black"
                  whileHover={{ scale: 1.1, backgroundColor: "#000", color: "#fff" }}
                ...
                <motion.a
                  href="https://x.com/@navneettushar"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white p-2 lg:p-3 rounded border-2 border-black"
                  whileHover={{ scale: 1.1, backgroundColor: "#000", color: "#fff" }}
        ...
        >
          ...
          <p className='text-[#71717A] text-sm/6 lg:text-base mt-3 lg:mt-6'>I seek to push the limits of creativity to create high-engaging, user-friendly, and memorable interactive experiences. Let&apos;s collaborate to build something amazing together!</p>

          <div className='font-semibold text-sm lg:text-xl flex flex-col mt-6 gap-2 lg:gap-4'>
            <motion.a
              whileHover={{ x: 5 }}
              className='flex items-center gap-2 group'
              href="mailto:tusharnavneet3@gmail.com"
            >
              <span className='border-2 transition-all border-transparent group-hover:border-black rounded-full p-1'>
                <IoMdMail className="w-4 h-4 lg:w-5 lg:h-5" />
              </span>
              tusharnavneet3@gmail.com
            </motion.a>

            <motion.a
              whileHover={{ x: 5 }}
              className='flex items-center gap-2 group'
              href="tel:+918709661636"
            >
